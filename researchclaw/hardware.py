...
def _detect_nvidia() -> HardwareProfile | None:
    ...
    try:
        ...
        return HardwareProfile(
            has_gpu=True, gpu_type="cuda", gpu_name=gpu_name,
            vram_mb=vram_mb, tier=tier, warning=warning,
        )
...
def _detect_mps() -> HardwareProfile | None:
    ...
    return HardwareProfile(
        has_gpu=True, gpu_type="mps", gpu_name=gpu_name,
        vram_mb=None, tier="limited",
        warning=(
